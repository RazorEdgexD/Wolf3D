...
/*   Updated: 2017/03/09 17:06:42 by aosobliv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_texture(t_wolf *wolf)
{
	...
	wolf->wall[5].img = mlx_xpm_file_to_image(wolf->mlx, "texture/wood.xpm", &wolf->wall[5].width,
		&wolf->wall[5].height);
	wolf->wall[6].img = mlx_xpm_file_to_image(wolf->mlx, "texture/purplestone.xpm", &wolf->wall[6].width,
		&wolf->wall[6].height);
	wolf->wall[7].img = mlx_xpm_file_to_image(wolf->mlx, "texture/greystone.xpm", &wolf->wall[7].width,
		&wolf->wall[7].height);

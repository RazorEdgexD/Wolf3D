...
/*   Updated: 2017/03/09 20:02:57 by aosobliv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_texture(t_wolf *wolf)
{
	...
	wolf->wall[0].img = mlx_xpm_file_to_image(wolf->mlx, "texture/redbrick.xpm",
		&wolf->wall[0].width, &wolf->wall[0].height);
	wolf->wall[1].img = mlx_xpm_file_to_image(wolf->mlx, "texture/bluestone.xpm"
	...
	wolf->wall[6].img = mlx_xpm_file_to_image(wolf->mlx,
		"texture/ceiling_01.xpm", &wolf->wall[6].width,
			&wolf->wall[6].height);
	wolf->wall[7].img = mlx_xpm_file_to_image(wolf->mlx, "texture/floor_01.xpm",
		&wolf->wall[7].width, &wolf->wall[7].height);
	wolf->wall[8].img = mlx_xpm_file_to_image(wolf->mlx, "texture/door.xpm",
